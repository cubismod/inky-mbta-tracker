...
async def get_validation_history(
    ...
    """
    Get recent validation history for a station and route.
    ...
    try:
        ...
        # to store validation history in a more structured way
        validations = []

        # Search for validation keys in the recent past
        ...
        while current_date <= end_date:
            ...
            # to use a different data structure for efficient querying
        ...
        logger.error(
            "Failed to get validation history due to Redis connection issue",
            exc_info=e,
        )
        return []
