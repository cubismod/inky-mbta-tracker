...
class TestConnectionTracker:
    ...
    @pytest.mark.asyncio
    async def test_can_connect_when_under_limit(self, connection_tracker):
        """Test that connections are allowed when under the limit."""
        ip = "192.168.1.1"
        assert await connection_tracker.can_connect(ip) is True

    @pytest.mark.asyncio
    async def test_add_connection_success(self, connection_tracker):
    ...
    @pytest.mark.asyncio
    async def test_add_multiple_connections(self, connection_tracker):
    ...
    @pytest.mark.asyncio
    async def test_connection_limit_enforcement(self, connection_tracker):
    ...
    @pytest.mark.asyncio
    async def test_remove_and_add_again(self, connection_tracker):
    ...
    @pytest.mark.asyncio
    async def test_different_ips_independent(self, connection_tracker):
    ...
    @pytest.mark.asyncio
    async def test_get_connection_count_zero(self, connection_tracker):
    ...
    @pytest.mark.asyncio
    async def test_remove_nonexistent_connection(self, connection_tracker):
    ...
    @pytest.mark.asyncio
    async def test_custom_max_connections(self, redis_client):
    ...
    @pytest.mark.asyncio
    async def test_connection_key_format(self, connection_tracker):
